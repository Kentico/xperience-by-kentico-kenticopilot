...
- You can use the migrate-code-page-visual skill to fix visual issues caused by the migration.

The page migration is now complete. Continue migrating other pages by repeatedly running migrate-code-page-widgets and migrate-code-page. To migrate shared components such as layouts, headers, footers, use migrate-code-component.
```
