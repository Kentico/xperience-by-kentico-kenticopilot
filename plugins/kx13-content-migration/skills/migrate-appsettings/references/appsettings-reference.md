...
| `MigrationProtocolPath` | `<WorkspaceRoot>/MigrationProtocol/protocol.txt` | Infrastructure — protocol log at workspace root, required for post-migration evaluation (migrate-eval skill) |
